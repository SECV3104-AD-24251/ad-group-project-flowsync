  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-4 justify-center">
        ...
        <div class="p-4 lg:w-1/3">
            <a href="{{ route('timetable') }}" class="block h-full bg-gradient-to-r from-red-100 to-red-300 hover:from-red-200 hover:to-red-400 transition-all duration-300 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative shadow-lg hover:shadow-2xl">
        ...
        <!-- SECOND BOX (CALENDAR) -->
        <div class="p-4 lg:w-1/3">
            <div class="h-full bg-gradient-to-r from-red-100 to-red-300 hover:from-red-200 hover:to-red-400 transition-all duration-300 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative shadow-lg hover:shadow-2xl">
                ...
                <a class="text-black-700 inline-flex items-center font-bold hover:underline">Learn More
                    <svg class="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M5 12h14"></path>
                        <path d="M12 5l7 7-7 7"></path>
                    </svg>
